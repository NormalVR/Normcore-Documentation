...
- name: Properties
  ...
  - name: prefabName
    ...
    summary: The name of the prefab that this view is an instance of. This is only set on root prefab views.
    remarks: This property is accessible in OnRealtimeModelReplaced and later (after a model is assigned to this view). It's not available during Awake, Start, OnEnable.
  - name: isChildView
...
- name: Methods
  ...
  - name: ClearOwnershipOfSelfAndChildren
    definition: void ClearOwnershipOfSelfAndChildren()
