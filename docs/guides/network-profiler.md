...
In our sample, we have implemented the following **PrefabPool**, that will create instances up to a certain limit and reuse the oldest instance when the instance limit is reached.
