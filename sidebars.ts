...
const sidebars: SidebarsConfig = {
  sidebar: [
    ...
    },
    {
      ...
      collapsible: true,
      items: [
        { type: 'category', label: 'Realtime', collapsible: true, items: [
        ...
        { type: 'category', label: 'Room + Datastore', collapsible: true, items: [
          ...
          { type: 'doc', label: 'RealtimePropertyType', id: 'reference/classes/RealtimePropertyType' },
          ...
          { type: 'doc', label: 'DisconnectEvent', id: 'reference/classes/Normal.Realtime.DisconnectEvent' },
          { type: 'doc', label: 'ConnectionStatistics', id: 'reference/classes/Normal.Realtime.ConnectionStatistics' },
          { type: 'doc', label: 'ChannelFlags', id: 'reference/classes/Normal.Realtime.ChannelFlags' },
        ]},
        { type: 'category', label: 'Collections', collapsible: true, items: [
        ...
        { type: 'category', label: 'Components', collapsible: true, items: [
          { type: 'doc', label: 'RealtimeTransform', id: 'reference/classes/Normal.Realtime.RealtimeTransform' },
          { type: 'doc', label: 'RealtimeAnimator', id: 'reference/classes/Normal.Realtime.RealtimeAnimator' },
          { type: 'doc', label: 'EasySync', id: 'reference/classes/Normal.Realtime.EasySync' },
          { type: 'doc', label: 'AutoReconnect', id: 'reference/classes/Normal.Realtime.AutoReconnect' },
        ]},
